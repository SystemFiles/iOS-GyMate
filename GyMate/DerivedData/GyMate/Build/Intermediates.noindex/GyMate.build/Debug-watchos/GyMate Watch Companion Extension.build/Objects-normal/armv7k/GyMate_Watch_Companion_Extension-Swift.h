...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GyMate_Watch_Companion_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class WKRefreshBackgroundTask;

SWIFT_CLASS("_TtC32GyMate_Watch_Companion_Extension17ExtensionDelegate")
...
SWIFT_CLASS("_TtC32GyMate_Watch_Companion_Extension22NotificationController")
